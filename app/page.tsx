  ...
  return (
    <main className="landing-page-root" style={{ overflowX: 'hidden', position: 'relative', minHeight: '100vh', backgroundColor: 'var(--background)' }}>
      ...
      <section className="vrsa-hero-container">
        ...
        {/* Original Main Title */}
        <h1 className="vrsa-hero-title">
          Unlock Academic <span className="serif-italic">Excellence</span>.<br />
        ...
        {/* Original Subtitle */}
        <p className="vrsa-hero-subtitle">
        ...
        <div className="vrsa-hero-buttons">
          <Link href="/login" className="btn-primary-hero" style={{ textDecoration: 'none' }}>
            Login Now →
          </Link>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3rem', alignItems: 'center' }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <span>📸</span> Real Campus Snapshot
            </div>
